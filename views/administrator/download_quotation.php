...
$client_address = htmlentities(($quote['rue'] ?? '') . ', ' . ($quote['cp'] ?? '') . ' ' . ($quote['ville'] ?? ''), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8');
...
$logoPath = __DIR__ . '/../../assets/statics/images/logo.png'; // chemin réel sur serveur
$logoData = '';
