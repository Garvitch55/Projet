    ...
    <nav class="mt-3">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
                ...
                <?php else: ?>
                    <a class="page-link bg-orange-fonce text-white" href="?page=<?= max(1, $currentPage - 1) ?>">&laquo;</a>
                <?php endif; ?>
            </li>
            ...
            <li class="page-item">
                ...
                <?php else: ?>
                    <a class="page-link bg-orange-fonce text-white" href="?page=<?= min($totalPages, $currentPage + 1) ?>">&raquo;</a>
                <?php endif; ?>
            </li>
